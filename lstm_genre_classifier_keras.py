...
model.add(LSTM(units=33,  dropout=0.05, recurrent_dropout=0.35, return_sequences=True))
model.add(LSTM(units=33,  dropout=0.05, recurrent_dropout=0.35, return_sequences=False))
