...
if __name__ == "__main__":
    PATH = sys.argv[1] if len(sys.argv) == 2 else "./audio/James.021.au"
    MODEL = load_model("./weights/lstm_genre_classifier_lstm.json", "./weights/lstm_genre_classifier_lstm.h5")
    GENRE = get_genre(MODEL, PATH)
    print("All catagories:"+str(GenreFeatureData().genre_list))
